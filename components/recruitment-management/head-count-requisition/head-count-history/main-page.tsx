...
import HeadCountHistoryFilter from '../head-count-approval/head-count-approval-filter'
    ...
    return (
        <section className="w-full p-4 px-6">
            ...
            <TableFrameFilter
                ...
                open={open}
            />
            <HeadCountHistoryFilter open={open} setOpen={setOpen} />
            <HeadCountColorLegend language="headCountHistory" />
            <DataTable
