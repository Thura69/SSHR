...
import DataHeadCountSelect from './data-select'
import MultiHeadCountSelect from './multi-select'
import MultiHeadCountEnumSelect from './multi-select-enum'
import {
    HEADCOUNT_STATUS,
    JOB_LOCATION_TYPES,
    URGENCY_LEVEL,
...
export interface HeadCountFilterDataType {
    company_id: string[]
    location_id: string[]
    branch_id: string[]
