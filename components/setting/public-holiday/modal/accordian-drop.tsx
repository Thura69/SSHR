...
import AccordianChil from './accordian-chil';
import {Skeleton} from '../../../ui/skeleton';

function AccordianDrop({value,handleUpdate,setAll,allValue}:{value:any,handleUpdate:any,setAll?:any,allValue?:any}) {
   
   const {isLoading:disLoad,data:disCompany} = useGetAllDistCompany();
   const {isLoading:disbrLoad,data:brsde} = useGetAllDistBranch();
   const {isLoading:disLo,data:dislo} = useGetAllDistLocation();
   const {isLoading:disdeLoad,data:disde} = useGetAllDistDepart();
   const {isLoading:disPoLoad,data:dipo} = useGetAllPostions();
