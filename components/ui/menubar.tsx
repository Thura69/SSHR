...
>(({ className, children, checked, ...props }, ref) => (
    <MenubarPrimitive.CheckboxItem
        ref={ref}
        className={cn(
            'relative flex cursor-default text-[#A3A3A3] font-bold  select-none items-center rounded-sm py-1.5 pl-10 pr-2 text-sm outline-none focus:bg-slate-100  data-[disabled]:pointer-events-none data-[disabled]:opacity-50  dark:focus:text-slate-50',
            className,
